...
function summary(id, pagefaults, pages, frames) {
    ...
    summary += ` <br> Pages:${pages}</div>`; 
    summary += ` <br> Frames:${frames}</div>`; 
    summary += ` <br> Hits:${pages - pagefaults}</div>`;
    summary += ` <br> Faults:${pagefaults}</div>`;
    summary += ` <br> HitRatio:${hitratio} </div>`;
    summary += ` <br> MissRatio:${missratio}</div>`;
