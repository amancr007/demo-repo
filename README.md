...
You can see demo [here](https://bravergangsta510.github.io/demo-repo/)
...
You can visualize and play with the different algorithms of Page Replacement.

1. Fisrt In First Out
2. Least Recent Used
3. Optimal Algorithm
4. Last In First Out
5. Most Recent Used
